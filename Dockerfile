...
RUN set -o pipefail \
  ...
  && curl -f -s -L -o client-tools/helm/v3.12.0/helm https://app.harness.io/public/shared/tools/helm/release/v3.12.0/bin/linux/$TARGETARCH/helm || { echo "Failed to download helm"; exit 1; } \
  ...
  && mkdir -m 777 -p client-tools/scm/e92737411 \
  && curl -f -s -L -o client-tools/scm/e92737411/scm https://app.harness.io/public/shared/tools/scm/release/e92737411/bin/linux/$TARGETARCH/scm || { echo "Failed to download scm"; exit 1; } \
